      ...
      <>
        <div key={reservation.reservation_id} className="reservation-tile">
          <ul className="res-data-list">
            <li>
              Reservation ID: <span>{reservation.reservation_id}</span>
            </li>
            <li>
              First Name: <span>{reservation.first_name}</span>
            </li>
            <li>
              Last Name: <span>{reservation.last_name}</span>
            </li>
            <li>
              Mobile #: <span>{reservation.mobile_number}</span>
            </li>
            <li>
              Party size: <span>{reservation.people}</span>
            </li>
            <li>
              Reservation Time: <span>{reservation.reservation_time}</span>
            </li>
            <li>
              Reservation Date: <span>{reservation.reservation_date}</span>
            </li>
